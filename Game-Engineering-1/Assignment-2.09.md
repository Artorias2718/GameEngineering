...
- Implement a swept separating axis collision check as we discussed in our last class.
- Use it to detect collisions between objects in your game.
- You don't need to react to collisions but have some temporary way of notifying of a collision, like debug spew.
- Make sure you have a test case for rotated objects.
...
- Must be submitted to your tags folder in a directory labeled "Assignment2.09"